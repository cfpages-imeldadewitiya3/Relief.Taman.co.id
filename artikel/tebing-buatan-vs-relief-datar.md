---
article_id: RTF-01-03
title: "Tebing Buatan vs Relief Datar"
slug: "tebing-buatan-vs-relief-datar"
description: "Choose wall relief, cliff, pool feature, statue, ornament, or themed work"
status: outline
publication_date: "2025-12-05"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: RTF-01
primary_intent: "Compare dimensional formats"
reader_community: "Taman.co.id"
reader_address: "Kawan Taman.co.id"
final_route: "/artikel/tebing-buatan-vs-relief-datar.html"
...
# Tebing Buatan vs Relief Datar

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Tebing Buatan vs Relief Datar”
- **Reader and situation:** Choose wall relief, cliff, pool feature, statue, ornament, or themed work
- **Reader outcome:** Choose wall relief, cliff, pool feature, statue, ornament, or themed work
- **Primary intent:** Compare dimensional formats
...
- **Scope boundary:** Form decision
- **Final public route:** `/artikel/tebing-buatan-vs-relief-datar.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Tebing Buatan vs Relief Datar**.
...
- **Exact Markdown to insert:** `![Ilustrasi relief Tebing](/wp-content/uploads/2024/08/relief-Tebing.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `relief Tebing` as relevant content media; no pixels were inspected.
...
- `/jasa-relief-tebing-tanah-datar.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-relief-tebing-tanah-datar` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- `/jasa-relief-tema-tanah-datar.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-relief-tema-tanah-datar` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `RTF-01-01` → `/artikel/brief-proyek-relief-taman.html` — Cara Menyusun Brief Proyek Relief Taman
- `RTF-01-02` → `/artikel/relief-dinding-vs-patung-taman.html` — Relief Dinding vs Patung Taman
- `RTF-01-04` → `/artikel/relief-kolam-vs-ornamen-kering.html` — Relief Kolam vs Ornamen Kering
- `RTF-01-05` → `/artikel/relief-custom-vs-modular.html` — Karya Custom vs Modul Berulang
...
- **Tie back to this article:** Keep the explanation specific to “Tebing Buatan vs Relief Datar”.
