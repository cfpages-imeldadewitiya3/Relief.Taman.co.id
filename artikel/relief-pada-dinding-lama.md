---
article_id: RTF-08-03
title: "Relief di Dinding Lama atau Retak"
slug: "relief-pada-dinding-lama"
...
date_modified: null
parent_topic: RTF-08
primary_intent: "Screen retrofit risk"
reader_community: "Taman.co.id"
reader_address: "Teman Taman.co.id"
final_route: "/artikel/relief-pada-dinding-lama.html"
...
# Relief di Dinding Lama atau Retak

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Relief di Dinding Lama atau Retak”
...
- **Primary intent:** Screen retrofit risk
...
- **Scope boundary:** Competent assessment
- **Final public route:** `/artikel/relief-pada-dinding-lama.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Relief di Dinding Lama atau Retak**.
...
- **Exact Markdown to insert:** `![Ilustrasi Relief Dinding 4](/wp-content/uploads/2024/07/Relief-Dinding-4.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Relief Dinding 4` as relevant content media; no pixels were inspected.
...
- `RTF-08-01` → `/artikel/checklist-survei-tapak-relief.html` — Checklist Survei Tapak Relief
- `RTF-08-02` → `/artikel/input-struktur-relief.html` — Input Beban dan Support Relief
- `RTF-08-04` → `/artikel/anchor-relief-dan-waterproofing.html` — Koordinasi Anchor dengan Waterproofing
...
- **Tie back to this article:** Keep the explanation specific to “Relief di Dinding Lama atau Retak”.
