---
article_id: RTF-01-04
title: "Relief Kolam vs Ornamen Kering"
slug: "relief-kolam-vs-ornamen-kering"
...
date_modified: null
parent_topic: RTF-01
primary_intent: "Compare wet/dry exposure"
reader_community: "Taman.co.id"
reader_address: "Sobat Taman.co.id"
final_route: "/artikel/relief-kolam-vs-ornamen-kering.html"
...
# Relief Kolam vs Ornamen Kering

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Relief Kolam vs Ornamen Kering”
...
- **Primary intent:** Compare wet/dry exposure
...
- **Scope boundary:** Water interface
- **Final public route:** `/artikel/relief-kolam-vs-ornamen-kering.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Relief Kolam vs Ornamen Kering**.
...
- **Exact Markdown to insert:** `![Ilustrasi Relief Kolam 5](/wp-content/uploads/2024/08/Relief-Kolam-5.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Relief Kolam 5` as relevant content media; no pixels were inspected.
...
- `RTF-01-03` → `/artikel/tebing-buatan-vs-relief-datar.html` — Tebing Buatan vs Relief Datar
- `RTF-01-05` → `/artikel/relief-custom-vs-modular.html` — Karya Custom vs Modul Berulang
- `RTF-01-06` → `/artikel/kapan-relief-kurang-tepat.html` — Kapan Relief Kurang Tepat untuk Tapak?
...
- **Tie back to this article:** Keep the explanation specific to “Relief Kolam vs Ornamen Kering”.
